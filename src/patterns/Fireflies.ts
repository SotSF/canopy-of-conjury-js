...
import { MemoizedMap, Memoizer } from "./memoizer";
...
export class Fireflies extends BasePattern {
  ...
  constructor(props: FireFliesProps) {
    super(props);
  ...
  serializeExtra(): SerializedFireflies {
    return {
      fireflies: this.fireflies,
    };
  }

  deserializeExtra(object: SerializedFireflies) {
